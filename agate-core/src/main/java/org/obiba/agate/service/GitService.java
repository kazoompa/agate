...
import org.obiba.agate.domain.GitIdentifier;
import org.obiba.agate.domain.GitPersistable;
import org.obiba.core.util.FileUtil;
import org.obiba.git.CommitInfo;
import org.obiba.git.GitException;
import org.obiba.git.GitUtils;
import org.obiba.git.command.*;
...
public class GitService {
    ...
    private static final String PATH_DATA = "${AGATE_HOME}/data/git";

    private static final String PATH_CLONES = "${AGATE_HOME}/work/git";
    ...
    public void init() {
        ...
        if(clonesRoot == null) {
            clonesRoot = new File(PATH_CLONES.replace("${AGATE_HOME}", System.getProperty("AGATE_HOME")));
        }
    }
